...
namespace BetterSongList.HarmonyPatches.UI {
	[HarmonyPatch(typeof(LevelCollectionNavigationController), nameof(LevelCollectionNavigationController.DidActivate))]
	static class BottomUI {
		...
		static void Postfix(LevelCollectionNavigationController __instance) {
			...
			__instance._hideDetailViewController = false;
		}
